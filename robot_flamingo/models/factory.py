...
def create_model_and_transforms(
    ...
    Returns:
        Flamingo: Flamingo model from parser.add_argument("--decoder_type", type=str, default='lstm')pretrained vision and language encoders
    ...
    if debug:
        ...
        lang_encoder = AutoModelForCausalLM.from_pretrained(lang_encoder_path, ignore_keys=["config"],
