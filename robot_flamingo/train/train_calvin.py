...
from train_utils import get_checkpoint, train_one_epoch_calvin, train_one_epoch_calvin_diff, \
    train_one_epoch_calvin_cotrain, train_one_epoch_calvin_two_way, \
...
from robot_flamingo.eval.eval_utils import eval_one_epoch_calvin_with_dataloder
...
def main():
    ...
    parser.add_argument("--calvin_conf_path",
                        default="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/calvin/calvin_models/conf",
                        type=str, help="path to calvin_conf_path", )
    ...
    parser.add_argument('--episode_rank', type=int, default=4)
    parser.add_argument(
        "--last_action",
        default=False,
        action="store_true",
    ...
    parser.add_argument("--episode_loss", type=str, default='point')
    ...
    parser.add_argument("--clip_cache_dir",
                        default="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/RoboFlamingo/checkpoints",
                        type=str)

    parser.add_argument("--data_type", type=str, default='calvin')
    parser.add_argument("--take_steps", type=int, default=5)

    # for sim
    parser.add_argument("--batch_size_sim", type=int, default=1)
    parser.add_argument("--calvin_seq_path",
                        default="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/yanfeng/project/robotic/RoboFlamingo/eval_sequences.json",
                        type=str, help="path to calvin_seq_path", )
    ...
    for epoch in range(resume_from_epoch, args.num_epochs):
        ...
        if args.test_during_training:
            eval_log_dir = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/huangyiyang02/log/use"
            ddp_model.eval()
