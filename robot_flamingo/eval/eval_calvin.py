...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="whether to use episode or not",
    )
    parser.add_argument(
        "--fusion_mode",
        default="post",
    ...
    parser.add_argument("--action_num", type=int, default=1, help="multiple step action prediction")
    parser.add_argument("--skip_steps", type=int, default=1, help="multiple step action prediction")
    parser.add_argument("--mask_ratio", type=float, default=0.0, help="multiple step action prediction")
    ...
    eval_log_dir = None
    # if args.visualize:
    eval_log_dir = '{}_action_num_{}_h'.format(args.evaluate_from_checkpoint.split('.')[0],args.action_num)
